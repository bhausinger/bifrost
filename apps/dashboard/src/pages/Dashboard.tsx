          ...
          <>
            ...
            <div className="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-4">
              ...
              <div className="kpi-card flex items-center justify-between">
                <div>
                  <p
                    className={`font-mono text-2xl font-bold ${margin >= 0 ? 'text-emerald-600' : 'text-red-600'}`}
                  >
                    ${margin.toLocaleString()}
                  </p>
                  <p className="mt-0.5 text-sm font-medium text-gray-500">Profit</p>
                  <p className="text-xs text-gray-400">
                    ${totalSpent.toLocaleString()} paid to curators
                  </p>
                </div>
                <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-gray-200 bg-white">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              ...
              <div className="card p-6">
                <h2 className="mb-5 font-display text-xs font-bold uppercase tracking-widest text-gray-400">
                  Pipeline Breakdown
                </h2>
                  ...
                  {[
                    ...
                    return (
                      <div key={stage} className="flex items-center gap-3">
                        ...
                        <div className="w-10 text-right font-mono text-sm font-bold text-gray-700">
                          {count}
                        </div>
                      </div>
                    )
                  ...
                  {[
                    {
                      ...
                      icon: Wrench,
                      title: 'Open Pipeline',
                      desc: 'Manage your kanban board',
                    },
                    {
                      href: '/outreach',
                      icon: Mail,
                      title: 'Send Bulk Email',
                      desc: 'Reach out to pipeline leads',
                    },
                    {
                      href: '/curators',
                      icon: Music,
                      title: 'Manage Curators',
                      desc: 'Your playlist network',
                    },
                    {
                      href: '/financials',
                      icon: DollarSign,
                      title: 'View Financials',
                      desc: 'Revenue, expenses, and P&L',
                    },
                  ].map((item) => (
                    <a
                      key={item.href}
